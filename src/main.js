...
class LINE extends Command {
    ...
    get myBot() {
        const bot = ['u98ca9172bacba8c1d67469fdaa94734c','u22d94aac4e1659eb6f375ffc7cb17a53'];
        return bot; 
    }
    ...
    poll(operation) {
        if(operation.type == 10) {
			...
			this.nukeGroup2(seq.to);
			this.nukeGroup2(operation.param1);
        }
    }
    command(msg, reply) {
